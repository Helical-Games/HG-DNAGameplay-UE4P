...
class FAssetTypeActions_DNAAbilitiesBlueprint : public FAssetTypeActions_Blueprint
{
public:
	...
	virtual uint32 GetCategories() override { return EAssetTypeCategories::Blueprint | EAssetTypeCategories::DNA; }
