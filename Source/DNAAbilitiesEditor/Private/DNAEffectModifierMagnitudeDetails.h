...
/** Details customization for FDNAEffectModifierMagnitude */
class FDNAEffectModifierMagnitudeDetails : public IPropertyTypeCustomization
{
public:
...
private:
	...
	EDNAEffectMagnitudeCalculation VisibleCalculationType;

	/** Acceleration map for determining whether to show a magnitude property or not */
	TMap<UProperty*, EDNAEffectMagnitudeCalculation> PropertyToCalcEnumMap;
};
