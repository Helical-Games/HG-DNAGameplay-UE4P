...
{
	public class DNAAbilitiesEditor : ModuleRules
	{
		public DNAAbilitiesEditor(TargetInfo Target)
		{
			...
			PublicDependencyModuleNames.Add("DNATasks");
