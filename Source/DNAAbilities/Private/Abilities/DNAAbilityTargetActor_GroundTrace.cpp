...
// --------------------------------------------------------------------------------------------------------------------------------------------------------
//
//	ADNAAbilityTargetActor_GroundTrace
//
// --------------------------------------------------------------------------------------------------------------------------------------------------------

ADNAAbilityTargetActor_GroundTrace::ADNAAbilityTargetActor_GroundTrace(const FObjectInitializer& ObjectInitializer)
: Super(ObjectInitializer)
{
	CollisionHeightOffset = 0.0f;
}

void ADNAAbilityTargetActor_GroundTrace::StartTargeting(UDNAAbility* InAbility)
{
...
bool ADNAAbilityTargetActor_GroundTrace::AdjustCollisionResultForShape(const FVector OriginalStartPoint, const FVector OriginalEndPoint, const FCollisionQueryParams Params, FHitResult& OutHitResult) const
{
...
FHitResult ADNAAbilityTargetActor_GroundTrace::PerformTrace(AActor* InSourceActor)
{
	static const FName LineTraceSingleName(TEXT("ADNAAbilityTargetActor_GroundTrace"));
...
bool ADNAAbilityTargetActor_GroundTrace::IsConfirmTargetingAllowed()
{
