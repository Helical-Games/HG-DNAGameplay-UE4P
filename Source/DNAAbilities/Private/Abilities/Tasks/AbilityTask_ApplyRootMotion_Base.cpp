...
UDNAAbilityTask_ApplyRootMotion_Base::UDNAAbilityTask_ApplyRootMotion_Base(const FObjectInitializer& ObjectInitializer)
...
void UDNAAbilityTask_ApplyRootMotion_Base::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	DOREPLIFETIME(UDNAAbilityTask_ApplyRootMotion_Base, ForceName);
}

void UDNAAbilityTask_ApplyRootMotion_Base::InitSimulatedTask(UDNATasksComponent& InDNATasksComponent)
{
...
void UDNAAbilityTask_ApplyRootMotion_Base::SetFinishVelocity(FName RootMotionSourceName, FVector FinishVelocity)
{
...
void UDNAAbilityTask_ApplyRootMotion_Base::ClampFinishVelocity(FName RootMotionSourceName, float VelocityClamp)
{
	check(MovementComponent);
