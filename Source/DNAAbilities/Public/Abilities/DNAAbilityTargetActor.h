...
#include "DNAAbilityTargetActor.generated.h"
...
class DNAABILITIES_API ADNAAbilityTargetActor : public AActor
{
...
public:
	...
	FDNAAbilityTargetingLocationInfo StartLocation;
	
	/** Initialize and begin targeting logic  */
	virtual void StartTargeting(UDNAAbility* Ability);
	...
	virtual bool OnReplicatedTargetDataReceived(FDNAAbilityTargetDataHandle& Data) const;
	...
	TSubclassOf<ADNAAbilityWorldReticle> ReticleClass;		//Using a special class for replication purposes.
	...
	UPROPERTY()
	UDNAAbilitySystemComponent* GenericDelegateBoundASC;
};
