 ...
 */
UCLASS(MinimalAPI)
class UDNAAbilityTask_ApplyRootMotionJumpForce : public UDNAAbilityTask_ApplyRootMotion_Base
{
	...
	static UDNAAbilityTask_ApplyRootMotionJumpForce* ApplyRootMotionJumpForce(UDNAAbility* OwningAbility, FName TaskInstanceName, FRotator Rotation, float Distance, float Height, float Duration, float MinimumLandedTriggerTime, bool bFinishOnLanded, UCurveVector* PathOffsetCurve, UCurveFloat* TimeMappingCurve);
