...
UENUM()
enum class EDNAAbilityTaskNetSyncType : uint8
{
...
UCLASS(MinimalAPI)
class UDNAAbilityTask_NetworkSyncPoint : public UDNAAbilityTask
{
	...
	static UDNAAbilityTask_NetworkSyncPoint* WaitNetSync(UDNAAbility* OwningAbility, EDNAAbilityTaskNetSyncType SyncType);
...
protected:
	...
	EDNAAbilityTaskNetSyncType SyncType;
};
