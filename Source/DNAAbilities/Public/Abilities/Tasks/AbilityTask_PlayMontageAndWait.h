...
UCLASS(MinimalAPI)
class UDNAAbilityTask_PlayMontageAndWait : public UDNAAbilityTask
{
	...
	static UDNAAbilityTask_PlayMontageAndWait* CreatePlayMontageAndWaitProxy(UDNAAbility* OwningAbility,
