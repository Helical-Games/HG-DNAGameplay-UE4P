...
UCLASS(MinimalAPI)
class UDNAAbilityTask_SpawnActor: public UDNAAbilityTask
{
	...
	static UDNAAbilityTask_SpawnActor* SpawnActor(UDNAAbility* OwningAbility, FDNAAbilityTargetDataHandle TargetData, TSubclassOf<AActor> Class);
	...
	bool BeginSpawningActor(UDNAAbility* OwningAbility, FDNAAbilityTargetDataHandle TargetData, TSubclassOf<AActor> Class, AActor*& SpawnedActor);

	UFUNCTION(BlueprintCallable, meta = (HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "true"), Category = "Abilities")
	void FinishSpawningActor(UDNAAbility* OwningAbility, FDNAAbilityTargetDataHandle TargetData, AActor* SpawnedActor);

protected:
	FDNAAbilityTargetDataHandle CachedTargetDataHandle;
};
