 ...
 */
UCLASS()
class DNAABILITIES_API UDNAAbilityTask_Repeat : public UDNAAbilityTask
{
	...
	static UDNAAbilityTask_Repeat* RepeatAction(UDNAAbility* OwningAbility, float TimeBetweenActions, int32 TotalActionCount);
