 ...
 */
UCLASS(MinimalAPI)
class UDNAAbilityTask_ApplyRootMotionConstantForce : public UDNAAbilityTask_ApplyRootMotion_Base
{
	...
	static UDNAAbilityTask_ApplyRootMotionConstantForce* ApplyRootMotionConstantForce(UDNAAbility* OwningAbility, FName TaskInstanceName, FVector WorldDirection, float Strength, float Duration, bool bIsAdditive, bool bDisableImpartingVelocityOnRemoval, UCurveFloat* StrengthOverTime);
