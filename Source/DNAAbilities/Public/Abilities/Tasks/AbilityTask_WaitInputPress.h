 ...
 */
UCLASS()
class DNAABILITIES_API UDNAAbilityTask_WaitInputPress : public UDNAAbilityTask
{
	...
	static UDNAAbilityTask_WaitInputPress* WaitInputPress(UDNAAbility* OwningAbility, bool bTestAlreadyPressed=false);
