...
#include "DNAAbilityTargetDataFilter.generated.h"
...
struct DNAABILITIES_API FDNATargetDataFilter
{
	GENERATED_USTRUCT_BODY()

	virtual ~FDNATargetDataFilter()
	{
	}
...
USTRUCT(BlueprintType)
struct DNAABILITIES_API FDNATargetDataFilterHandle
{
	GENERATED_USTRUCT_BODY()

	TSharedPtr<FDNATargetDataFilter> Filter;
