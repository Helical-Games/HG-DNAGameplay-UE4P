...
#include "DNATagsK2Node_SwitchDNATagContainer.generated.h"

struct FDNATagContainer;

UCLASS(MinimalAPI)
class UDNATagsK2Node_SwitchDNATagContainer : public UK2Node_Switch
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category = PinOptions)
	TArray<FDNATagContainer> PinContainers;
