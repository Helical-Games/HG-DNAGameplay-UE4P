...
#include "DNATagsK2Node_MultiCompareDNATagAssetInterfaceSingleTags.h"
#include "KismetCompiler.h"

UDNATagsK2Node_MultiCompareDNATagAssetInterfaceSingleTags::UDNATagsK2Node_MultiCompareDNATagAssetInterfaceSingleTags(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UDNATagsK2Node_MultiCompareDNATagAssetInterfaceSingleTags::AllocateDefaultPins()
{
	PinNames.Empty();
	...
	CreatePin(EGPD_Input, K2Schema->PC_Interface, TEXT(""), UDNATagAssetInterface::StaticClass(), false, false, TEXT("DNA Tag Asset Interface"));
...
void UDNATagsK2Node_MultiCompareDNATagAssetInterfaceSingleTags::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	UEdGraphPin* InPinSwitch = FindPin(TEXT("DNA Tag Asset Interface"));
	...
	for (int32 Index = 0; Index < NumberOfPins; ++Index)
	{
		...
		const UFunction* Function = UBlueprintDNATagLibrary::StaticClass()->FindFunctionByName(GET_FUNCTION_NAME_CHECKED(UBlueprintDNATagLibrary, DoesTagAssetInterfaceHaveTag));
...
FText UDNATagsK2Node_MultiCompareDNATagAssetInterfaceSingleTags::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
	return NSLOCTEXT("K2Node", "MultiCompare_TagAssetInterfaceSingleTags", "Compare Tag Asset Interface to Other Tags");
}

void UDNATagsK2Node_MultiCompareDNATagAssetInterfaceSingleTags::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void UDNATagsK2Node_MultiCompareDNATagAssetInterfaceSingleTags::AddPinToSwitchNode()
{
