...
#include "DNATagsK2Node_MultiCompareDNATagAssetInterface.h"
#include "KismetCompiler.h"

UDNATagsK2Node_MultiCompareDNATagAssetInterface::UDNATagsK2Node_MultiCompareDNATagAssetInterface(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UDNATagsK2Node_MultiCompareDNATagAssetInterface::AllocateDefaultPins()
{
	PinNames.Empty();
...
void UDNATagsK2Node_MultiCompareDNATagAssetInterface::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	for (int32 Index = 0; Index < NumberOfPins; ++Index)
	{
		...
		const UFunction* Function = UBlueprintDNATagLibrary::StaticClass()->FindFunctionByName(GET_FUNCTION_NAME_CHECKED(UBlueprintDNATagLibrary, HasAllMatchingDNATags));
...
FText UDNATagsK2Node_MultiCompareDNATagAssetInterface::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
	return NSLOCTEXT("K2Node", "MultiCompare_AssetInterface", "Compare Tag Asset Interface to Other Tag Containers");
}

void UDNATagsK2Node_MultiCompareDNATagAssetInterface::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void UDNATagsK2Node_MultiCompareDNATagAssetInterface::AddPinToSwitchNode()
{
